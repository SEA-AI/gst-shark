...
#ifndef __GST_DETECTION_COUNT_TRACER_H__
#define __GST_DETECTION_COUNT_TRACER_H__

#include "gstsharktracer.h"

G_BEGIN_DECLS

#define GST_TYPE_DETECTION_COUNT_TRACER \
    (gst_detection_count_tracer_get_type ())
G_DECLARE_FINAL_TYPE (GstDetectionCountTracer, gst_detection_count_tracer,
    GST, DETECTION_COUNT_TRACER, GstSharkTracer)

G_END_DECLS

#endif /* __GST_DETECTION_COUNT_TRACER_H__ */
